...
namespace Nuart.Modbus
{
    public class ModbusRtuClient : IModbusClient
    {
        ...
        //    #endregion Check
        public Response<bool[]> FuncCode01(int slaveAddress, int startCoilAddress, int coilQuantity, int responseTimeout)
        {
            // check parameters


            var reqBytes = Modbus.FuncCode01.BuildRtuRequest(slaveAddress, startCoilAddress, coilQuantity);
        ...
        public Response<byte[]> FuncCode03Byte(int slaveAddress, int startHoldingAddress, int quantity, int responseTimeout)
        {
            throw new NotImplementedException();
        }

        public Response<double[]> FuncCode03Double(int slaveAddress, int startHoldingAddress, int quantity, ByteOrder8 byteOrder, int responseTimeout)
        {
            throw new NotImplementedException();
        }

        public Response<float[]> FuncCode03Float(int slaveAddress, int startHoldingAddress, int quantity, ByteOrder4 byteOrder, int responseTimeout)
        {
            throw new NotImplementedException();
        }

        public Response<short[]> FuncCode03Int16(int slaveAddress, int startHoldingAddress, int quantity, ByteOrder2 byteOrder, int responseTimeout)
        {
            throw new NotImplementedException();
        }

        public Response<int[]> FuncCode03Int32(int slaveAddress, int startHoldingAddress, int quantity, ByteOrder4 byteOrder, int responseTimeout)
        {
            throw new NotImplementedException();
        }

        public Response<long[]> FuncCode03Int64(int slaveAddress, int startHoldingAddress, int quantity, ByteOrder8 byteOrder, int responseTimeout)
        {
            throw new NotImplementedException();
        }

        public Response<ushort[]> FuncCode03UInt16(int slaveAddress, int startHoldingAddress, int quantity, ByteOrder2 byteOrder, int responseTimeout)
        {
            throw new NotImplementedException();
        }

        public Response<uint[]> FuncCode03UInt32(int slaveAddress, int startHoldingAddress, int quantity, ByteOrder4 byteOrder, int responseTimeout)
        {
            throw new NotImplementedException();
        }

        public Response<ulong[]> FuncCode03UInt64(int slaveAddress, int startHoldingAddress, int quantity, ByteOrder8 byteOrder, int responseTimeout)
        {
            throw new NotImplementedException();
        }
    }
